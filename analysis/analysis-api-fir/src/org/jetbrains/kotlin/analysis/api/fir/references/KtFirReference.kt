...
import org.jetbrains.kotlin.analysis.low.level.api.fir.resolve.extensions.resolveExtensionReferenceTargetsPsiProvider
...
interface KtFirReference : KtReference, KtSymbolBasedReference {
    ...
    private fun KtSymbol.getPsiForGeneratedExtensionSymbol(): Collection<PsiElement>? {
        ...
        val targetPsiProvider = ktFile.virtualFile?.resolveExtensionReferenceTargetsPsiProvider ?: return null
        return with(targetPsiProvider) {
