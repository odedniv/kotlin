...
/**
 * Caches the names of classifiers and callables contained in a package. [LLFirSymbolProviderNameCache] is used by symbol providers such as
 * [org.jetbrains.kotlin.analysis.low.level.api.fir.providers.LLFirModuleWithDependenciesSymbolProvider] to abort symbol finding early if
 * the symbol name isn't contained in the symbol provider's domain.
 */
internal abstract class LLFirSymbolProviderNameCache(private val firSession: FirSession) {
    ...
    inline fun mayHaveTopLevelCallable(packageFqName: FqName, name: Name): Boolean {
