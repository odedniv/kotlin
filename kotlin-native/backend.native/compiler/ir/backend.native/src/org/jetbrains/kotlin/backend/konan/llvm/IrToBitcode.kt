...
internal class CodeGeneratorVisitor(
    ...
    private fun overrideRuntimeGlobals() {
        ...
        overrideRuntimeGlobal("Kotlin_auxGCThreads", llvm.constInt32(context.config.auxGCThreads))
...
internal fun NativeGenerationState.generateRuntimeConstantsModule() : LLVMModuleRef {
    ...
    setRuntimeConstGlobal("Kotlin_concurrentExtraSweep", llvm.constInt32(if (context.config.concurrentExtraSweep) 1 else 0))
