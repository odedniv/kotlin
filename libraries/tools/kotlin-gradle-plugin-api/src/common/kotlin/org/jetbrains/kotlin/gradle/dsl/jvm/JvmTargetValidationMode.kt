...
enum class JvmTargetValidationMode {
    /**
     * Ignores all JVM target mismatches and proceed with compilation.
     */
    IGNORE,

    /**
     * Produces warning message in the console output on JVM target mismatch and proceed with compilation.
     */
    WARNING,

    /**
     * Throws exception on JVM target mismatch and stops execution.
     */
    ERROR,
}
